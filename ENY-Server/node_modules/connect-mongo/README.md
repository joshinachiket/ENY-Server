...
// Basic usage
app.use(session({
    store: new MongoStore({ url: 'mongodb://http://10.3.16.163//test-app' })
}));

// Advanced usage
app.use(session({
    store: new MongoStore({
        url: 'mongodb://user12345:foobar@http://10.3.16.163//test-app?authSource=admins&w=1',
...
app.use(session({
    store: new MongoStore({
      url: 'mongodb://http://10.3.16.163//test-app',
